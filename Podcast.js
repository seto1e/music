...
const FEATURED_FEEDS = [
  { id: 'hk_top', name: '🇭🇰 香港熱門', rss: 'https://itunes.apple.com/hk/rss/toppodcasts/limit=25/json', lang: 'zh-HK' },
  { id: 'hk_news', name: '📰 新聞時事', rss: 'https://itunes.apple.com/hk/rss/toppodcasts/limit=25/genre=1489/json', lang: 'zh-HK' },
  { id: 'hk_edu', name: '📚 教育', rss: 'https://itunes.apple.com/hk/rss/toppodcasts/limit=25/genre=1304/json', lang: 'zh-HK' },
  { id: 'hk_biz', name: '💼 商業財經', rss: 'https://itunes.apple.com/hk/rss/toppodcasts/limit=25/genre=1321/json', lang: 'zh-HK' },
  { id: 'hk_health', name: '🏃 健康', rss: 'https://itunes.apple.com/hk/rss/toppodcasts/limit=25/genre=1512/json', lang: 'zh-HK' },
  { id: 'uk_top', name: '🇬🇧 UK Top', rss: 'https://itunes.apple.com/gb/rss/toppodcasts/limit=25/json', lang: 'en-GB' },
  { id: 'uk_news', name: '📰 UK News', rss: 'https://itunes.apple.com/gb/rss/toppodcasts/limit=25/genre=1489/json', lang: 'en-GB' },
  { id: 'bbc_learning', name: '🎓 BBC 6 Min English', rss: 'https://podcasts.files.bbci.co.uk/p02pc9zn.rss', lang: 'en-GB', type: 'rss_direct' },
  { id: 'bbc_english_speak', name: '💬 BBC English We Speak', rss: 'https://podcasts.files.bbci.co.uk/p02pc9tn.rss', lang: 'en-GB', type: 'rss_direct' },
  { id: 'bbc_global_news', name: '🌍 BBC Global News', rss: 'https://podcasts.files.bbci.co.uk/p02nq0gn.rss', lang: 'en-GB', type: 'rss_direct' },
  { id: 'bbc_in_our_time', name: '🧠 BBC In Our Time', rss: 'https://podcasts.files.bbci.co.uk/b006qykl.rss', lang: 'en-GB', type: 'rss_direct' },
  { id: 'bbc_world_service', name: '📡 BBC World Service', rss: 'https://podcasts.files.bbci.co.uk/p02nq0lx.rss', lang: 'en-GB', type: 'rss_direct' },
  { id: 'esl_beginner', name: '🐢 English at Your Own Pace', rss: 'https://feeds.feedburner.com/englishatyourownpace', lang: 'en', type: 'rss_direct' },
  { id: 'esl_pod', name: '📖 ESL Pod', rss: 'https://www.eslpod.com/website/eslpodcast.xml', lang: 'en', type: 'rss_direct' },
  { id: 'culips_esl', name: '🗣️ Culips ESL', rss: 'https://feeds.libsyn.com/51808/rss', lang: 'en', type: 'rss_direct' },
  { id: 'british_english_pod', name: '🇬🇧 British English Pod', rss: 'https://britishenglishpodcast.com/feed/podcast/', lang: 'en-GB', type: 'rss_direct' },
  { id: 'news_slow_english', name: '📰 News in Slow English', rss: 'https://www.newsinslowenglish.com/feed/podcast/', lang: 'en', type: 'rss_direct' },
  { id: 'us_top', name: '🇺🇸 English Top', rss: 'https://itunes.apple.com/us/rss/toppodcasts/limit=25/json', lang: 'en' },
  { id: 'en_tech', name: '💻 Technology', rss: 'https://itunes.apple.com/us/rss/toppodcasts/limit=25/genre=1318/json', lang: 'en' },
  { id: 'en_comedy', name: '😂 Comedy', rss: 'https://itunes.apple.com/us/rss/toppodcasts/limit=25/genre=1303/json', lang: 'en' },
  { id: 'en_true_crime', name: '🔍 True Crime', rss: 'https://itunes.apple.com/us/rss/toppodcasts/limit=25/genre=1488/json', lang: 'en' },
]
...
async function getSongs(ext) {
  try {
    ...
    // 優先用傳入嘅 feedUrl，冇就用 iTunes lookup
    let rssUrl = feedUrl ?? ''
...
async function getSongInfo(ext) {
  try {
    ...
    const lyricLines = []
    if (pubDate) lyricLines.push(`📅 ${pubDate}`)
    if (description) {
      lyricLines.push('')
      lyricLines.push(description)
    }
